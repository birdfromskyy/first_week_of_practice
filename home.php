...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         <span>ЗНАЙ, ГДЕ ВКУСНО! </span>
         <h3>Откройте для себя волшебство в каждом блюде с KING-FOOD</h3>
         <p>KING-FOOD - это не просто место, где вы можете насладиться вкусной едой. Это место, где каждый приём пищи становится незабываемым событием. Наши бургеры, пиццы, закуски и напитки приготовлены с любовью и заботой, чтобы удовлетворить ваши гастрономические желания. Мы гордимся тем, что предлагаем только самые свежие и качественные ингредиенты, чтобы каждый укус приносил вам удовольствие. Присоединяйтесь к нам и окунитесь в мир вкуса и удовольствия с KING-FOOD!</p>
...
<section class="home-category">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Пицца</h3>
         <p>Пицца - вкусное итальянское блюдо, оставляющее незабываемый след в вашем вкусовом опыте.</p>
         <a href="category.php?category=pizza" class="btn">Выбрать</a>
      </div>

      <div class="box">
         <img src="images/napitki.jpg" alt="" width="190" height="150">
         <h3>Напитки</h3>
         <p>Напитки - освежающий компаньон, дарящий удовольствие в каждом глотке.</p>
         <a href="category.php?category=napitki" class="btn">Выбрать</a>
      </div>

      <div class="box">
         <img src="images/burger.jpeg" alt="" width="190" height="150">
         <h3>Бургеры</h3>
         <p>Бургеры - взрыв вкуса с сочной котлетой, свежими овощами и аппетитными соусами.</p>
         <a href="category.php?category=burger" class="btn">Выбрать</a>
      </div>

      <div class="box">
         <img src="images/zakuski.jpg" alt="" width="190" height="150">
         <h3>Закуски</h3>
         <p>Закуски - залог яркого вечера, где каждый кусочек - это приглашение в мир наслаждения.</p>
         <a href="category.php?category=zakuski" class="btn">Выбрать</a>
      </div>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="" width="900" height="200">
