...
<section class="add-products">
   ...
   <h1 class="title">Добавить новый продукт</h1>
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>Выберите категорию</option>
               <option value="vegitables">Пицца</option>
               <option value="fruits">Напитки</option>
               <option value="meat">Бургеры</option>
      ...
      <input type="submit" class="btn" value="Добавить продукт" name="add_product">
      <p></p>
      <a href="admin_shop.php" class="btn">Обзор страницы</a>
   </form>
